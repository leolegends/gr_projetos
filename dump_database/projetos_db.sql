...
CREATE TABLE `comentarios` (
  ...
  `nome_comentarista` varchar(100) NOT NULL,
...
CREATE TABLE `projeto` (
  ...
  `analise` tinyint(1) DEFAULT NULL,
  `desenvolvendo` tinyint(1) DEFAULT NULL,
  `corrigindo` tinyint(1) DEFAULT NULL,
  `aprovado` tinyint(1) DEFAULT NULL,
  `entregue` tinyint(1) DEFAULT NULL,
  `pausar_projeto` tinyint(1) DEFAULT NULL,
  `data_inicio` date NOT NULL,
  `data_entrega` date DEFAULT NULL,
  `data_iniciado` date DEFAULT NULL,
  `data_analise` date DEFAULT NULL,
  `data_desenvolvendo` date DEFAULT NULL,
...
INSERT INTO `status` VALUES (1,'Iniciado'),(2,'Analise'),(3,'Desenvolvimento'),(4,'Corrigindo'),(5,'Aprovado'),(6,'Entregue');
